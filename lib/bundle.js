  ...
  for (let i = 0; i < 20; i++) {
    ...
    for (let j = 0; j < 20; j++) {
      ...
      allBubbles[i][j] = {
        x: xDistance,
        y: yDistance,
        color: __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.sample(__WEBPACK_IMPORTED_MODULE_0__colors__["a" /* default */]),
        display: 0,
        match: 0
      };
    }
...
// Creating a bubble
  ...
  function generateBubble() {
    if (currentBubbleColor === null) {
      currentBubbleColor = __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.sample(__WEBPACK_IMPORTED_MODULE_0__colors__["a" /* default */]);
    }
    return {
      x: initialX,
      y: initialY,
      ...
      if (x%2 !== 0) {
        for (var i = 0; i < diff.length; i++) {
          ...
          if (testBubble.color === color && testBubble.display === 1 && testBubble.match !== 1) {
            // console.log(testBubble.color);
            // console.log(testBubble.x);
            // console.log(testBubble.y);
            testBubble.match = 1;
            ...
            // if ((ct > 0 && deepNum === 0) || (ct > 1 && deepNum > 0)) {
...
// Main game loop
  ...
  function mainGame() {
    ...
    if (shoot) {
      ...
      collisionDetection();
      if (currentStatus === 3) {
        console.log("shift that bubble");
        bubbleShift();
      }
    }

    if (currentStatus === 4) {
      console.log("time to check those matches");
      checkMatches();
    }
